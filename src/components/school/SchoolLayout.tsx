...
const SchoolLayout = ({ children }: SchoolLayoutProps) => {
  ...
  const navItems = [
    ...
    { path: "/school/performance", label: "Performance", icon: TrendingUp },
      ...
      <header className="border-b bg-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display text-xl font-bold text-foreground">School Portal</h1>
              <p className="text-xs text-muted-foreground">{user?.email || "School Admin"}</p>
            </div>
          </div>
