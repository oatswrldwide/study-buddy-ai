...
import UniversityBursariesIndexPage from "./pages/UniversityBursariesIndexPage";
import UniversityBursaryPage from "./pages/UniversityBursaryPage";
      ...
      <AuthProvider>
        <HelmetProvider>
          <TooltipProvider>
            ...
            <Route path="/bursaries/universities" element={<UniversityBursariesIndexPage />} />
            <Route path="/bursaries/university/:slug" element={<UniversityBursaryPage />} />
            ...
            <Route path="/tvet-colleges" element={<TVETCollegesPage />} />
